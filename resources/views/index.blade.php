  ...
  <div id="hero" class="home">
    ...
    <div class="container">
      <div class="hero-content">
        <h1><span class="typed" data-typed-items="Los resultados del libro que desea"></span></h1>
        </div>
      </div>
    </div>
  </div><!-- End Hero -->
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="journal-info">
          ...
          <a href="blog-single.html"><img src="{{$libro['portada']}}" class="img-responsive" alt="img-center"></a>
          <div class="journal-txt">
            <h4><a href="blog-single.html">{{$libro['titulo']}}</a></h4>
            <p class="separator">{{$libro['descripcion']}}</p>
            <p class="separator">publicacion: {{$libro['fecha']}}</p>
            <p class="separator">Idioma: {{$libro['lenguaje']}}</p>
